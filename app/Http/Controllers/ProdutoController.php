...
class ProdutoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $feedback = [
            ...
            'descricao.min' => 'O campo nome deve ter no minimo 2 caracteres',
            'descricao.max' => 'O campo nome deve ter no maximo 2000 caracteres',
            'peso.integer' => 'O campo peso deve ser um numero inteiro',
            'unidade_id.exists' =>  'A unidade de medida informada nãoo existe',
            'fornecedor_id.exists' =>  'O fornecedor informado nãoo existe'
        ];
