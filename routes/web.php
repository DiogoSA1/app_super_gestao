...
Route::middleware('autenticacao:padrao,visitante')->prefix('/app')->group(function () {
    ...
    // Produtos Detalhes
    Route::resource('produto-detalhe', \App\Http\Controllers\ProductDetailController::class);
...
// Route::get('/','PrincipalController@principal'); Laravel versão 7.0.0
